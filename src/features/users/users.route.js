...
router.get("/me/settings", requireAuth, controller.getCurrentUserSettings);
router.patch(
  "/me/settings/notifications",
  requireAuth,
  validate(updateNotificationSettingsSchema),
  controller.updateCurrentUserNotificationSettings,
);
...
router.put(
  ...
  requireAuth,
  uploadProfileImage,
  controller.updateCurrentUserProfileImage,
);
router.delete(
  "/me/profile-image",
  requireAuth,
...
router.delete(
  ...
  controller.deactivateCurrentUserAccount,
);
